  ...
  settings: {
    ...
    providers: {
      ...
      presets: {
        ...
        asrVolcengineAgentPlan: 'Volcengine Ark Agent Plan ASR',
      ...
      volcengineAgentPlanMappingNote: 'Uses the Ark Agent Plan API Key. Resource ID defaults to volc.seedasr.sauc.duration.',
